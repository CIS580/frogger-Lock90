...
function render(elapsedTime, ctx) {
  ...
  ctx.fillStyle = "grey";
  ctx.fillRect(235, 0, 10, 30); 
  ctx.fillRect(235, 60, 10, 30);
  ctx.fillRect(235, 120, 10, 30);
  ctx.fillRect(235, 180, 10, 30);
  ctx.fillRect(235, 240, 10, 30);
  ctx.fillRect(235, 300, 10, 30);
  ctx.fillRect(235, 360, 10, 30);
  ctx.fillRect(235, 420, 10, 30);
  ctx.fillRect(235, 480, 10, 30);
  ctx.fillRect(475, 0, 10, 30); 
  ctx.fillRect(475, 60, 10, 30);
  ctx.fillRect(475, 120, 10, 30);
  ctx.fillRect(475, 180, 10, 30);
  ctx.fillRect(475, 240, 10, 30);
  ctx.fillRect(475, 300, 10, 30);
  ctx.fillRect(475, 360, 10, 30);
  ctx.fillRect(475, 420, 10, 30);
  ctx.fillRect(475, 480, 10, 30);
  ctx.fillStyle = "blue";
  ctx.fillRect(600, 0, 60, canvas.height);
  ctx.fillRect(660, 60, 60, 60);
  ctx.fillRect(660, 180, 60, 60);
  ctx.fillRect(660, 240, 60, 60);
  ctx.fillRect(660, 360, 60, 60);
